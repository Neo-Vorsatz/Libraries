...
## Functions
### Writing
`boolean_t mxSet(matrix *write, char rows, char columns, element_t elements[SIZE][SIZE]);`<br>
...
`boolean_t mxWriteElement(matrix *write, char row, char column, element_t entry);`<br>
...
`boolean_t mxWriteRow_len(matrix *write, char index, element_t *row, char arrLength);`<br>
...
`boolean_t mxWriteRow(matrix *write, char index, element_t *row);`<br>
...
`boolean_t mxWriteColumn_len(matrix *write, char index, element_t *column, char arrLength);`<br>
...
`boolean_t mxWriteColumn(matrix *write, char index, element_t *column);`<br>
Rewrites the content of a column (assumes the array length is perfectly sized).<br>
Takes a pointer to the matrix, the index of the row, and an array of entries.<br>
Returns 1 (true) if the process was successful, otherwise returns 0 (false).

`boolean_t mxInsertRow_len(matrix *write, char index, element_t *row, char arrLength);`<br>
Inserts a row of entries into the given index.<br>
Takes a pointer to the matix, the index of the row, an array of entries, and the length of that array.<br>
Returns 1 (true) if the process was successful, otherwise returns 0 (false).

`boolean_t mxInsertRow(matrix *write, char index, element_t *row);`<br>
Inserts a row of entries into the given index (assumes the array length is perfectly sized).<br>
Takes a pointer to the matrix, the index of the row, and an array of entries.<br>
Returns 1 (true) if the process was successful, otherwise returns 0 (false).

`boolean_t mxAppendRow_len(matrix *write, element_t *row, char arrLength);`<br>
...
`boolean_t mxAppendRow(matrix *write, element_t *row);`<br>
...
`boolean_t mxInsertColumn_len(matrix *write, char index, element_t *column, char arrLength);`<br>
...
`boolean_t mxInsertColumn(matrix *write, char index, element_t *column);`<br>
...
`boolean_t mxAppendColumn_len(matrix *write, element_t *column, char arrLength);`<br>
Appends a column of entries to the end of the matrix.<br>
Takes a pointer to the matix, an array of entries, and the length of that array.<br>
Returns 1 (true) if the process was successful, otherwise returns 0 (false).

`boolean_t mxAppendColumn(matrix *write, element_t *column);`<br>
...
`element_t mxReadElement(matrix *read, char row, char column);`<br>
...
`element_t mxDeterminant(matrix *read);`<br>
Takes a pointer to the matrix.<br>
...
`element_t mxSolveCramer(matrix *transform, matrix *result, char vector, char index);`<br>
